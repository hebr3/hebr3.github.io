...
◊link["https://projecteuler.net/problem=27"]{Project Euler}
...
◊figure["ProjectEuler27f.png"]
◊figure["ProjectEuler27g.png"]
...
◊figure["ProjectEuler27j.png"]

A larger time sink is that I am actually calculating out the first ◊${100 n} values for every combination of ◊bold{a} and◊bold{b}tested. Thus even if the second value calculated is non-Prime I still waste time evaluating the next 98 values.

Using the following code I can just check if the ◊${n} values are prime and stop when a non-Prime is found.

◊figure["ProjectEuler27k.png"]

To better understand how much time this saves, I calculated a ◊${50×50} array using the old method and the new method and had Mathematica generate an ◊bold{ArrayPlot} to save space.

◊figure["ProjectEuler27l.png"]
