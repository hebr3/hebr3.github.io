...
◊(define-meta title "ASM-DSL")
◊(define-meta published "2017-03-11")
◊(define-meta topics "CS231,Assembly,DSL")

I have been thinking about all of the boilerplate code that I keep writing in my assembly class and I decide to start looking into creating a simple ◊link["https://en.wikipedia.org/wiki/Domain-specific_language"]{DSL} to assist with my code writing.
...
◊filebox-highlight["example.asm" 'asm]{
...
#------ cin << $s0
li	$v0, 5
	syscall
...
◊filebox-highlight["example.cpp" 'c++]{
...
int s0, s1;
cin >> s0;
s1 = s0;
...
◊filebox-highlight["ASM-DSL.rkt" 'racket]{
#lang typed/racket
...
◊filebox-highlight["output.asm" 'asm]{
#------ cin << $s0
	li	$v0, 5
	syscall
	add	$v0, $s0, $0
