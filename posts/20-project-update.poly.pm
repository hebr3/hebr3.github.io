...
For my 20% Project I'm going to be learning to write code in ◊link["https://www.wolfram.com/mathematica/"]{Mathematica} to find solutions for the problems posted on Project Euler.

◊section[#:style 'unnumbered]{1 What are you going to learn (what is your "learning target")?}
...
◊section[#:style 'unnumbered]{2 How are you planning on learning it? (part of this learning must take place online)}

I plan to learn this through online video instructions, tutorials, and the documentation provided inside of Mathematica.


◊section[#:style 'unnumbered]{3 List your 10 authentic questions for inquiry. . .you only need the questions. The answers will come at the end of the project)}
...
◊section[#:style 'unnumbered]{4 What will a successful outcome look like (what is your "success criteria")?}

I would consider success for this project to be the completion of at least the first 50 problems on the site.


◊section[#:style 'unnumbered]{5 (Most importantly) Is there an aspect of play and/or making in your project. Is there an opportunity for failure? It is important that you avoid pure knowledge pursuits for this project.}
...
◊section[#:style 'unnumbered]{6 Which tool are you going to be using for research? (I know there was a request for more clarification on tools. We can do this Monday)}
