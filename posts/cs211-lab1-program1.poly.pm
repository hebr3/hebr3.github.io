...
◊(define-meta title "CS211-Lab1-Program1 in Racket")
◊(define-meta published "2017-01-25")
◊(define-meta topics "CS211,Racket,C++")

I'm currently taking ◊link["https://www.csusm.edu/assessment/portfolios/cs/bs/2012_14/cs_course_info.pdf"]{CS211} at ◊link["https://www.csusm.edu/"]{CSUSM} and I thought it would be interesting to try re-writing the labs in ◊link["https://racket-lang.org"]{Racket} after I submit the work in class. I figure that trying to solve the same problem with two different languages might help me to better understand the material and give me another excuse to keep messing around with Racket.
...
◊blockcode[#:filename "shoeSale.txt"]{
234019 52.89
234490 88.15
347269 35.26
239801 105.78
