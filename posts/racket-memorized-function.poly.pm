...
◊(define-meta title "Memoization in Racket")
◊(define-meta published "2017-04-1")
◊(define-meta topics "Racket,Dynamic Programming,Memoization")

After working on ◊link["https://codefights.com/challenge/DgH5cQEgpfu82oBQS"]{◊code{totalOnes}} last week I thought I would explore how I could implement memoization in racket. Working off an example I found ◊link["http://rayhightower.com/blog/2014/04/12/recursion-and-memoization/"]{here} I converted the standard definition of the fibonacci equation into an iterated form and a memoization form.

◊filebox-highlight["Fib" 'racket]{
(define (fib n)
  (cond [(= 0 n) 0]
        [(= 1 n) 1]
...
Unfortunately I was never able to find an iterative version of ◊code{totalOnes} code however, there is still a significant increase in speed associated with converting the equation to use memoization.
