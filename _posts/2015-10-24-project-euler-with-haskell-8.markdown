...
<figcaption>ProjectEuler8.hs</figcaption>
...
Once I had a list of `Int` it was rather straight forward to create groups of 13 integers and `map` `product` over them.
